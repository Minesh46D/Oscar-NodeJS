...
const { confirmPassword, checkEmailExist, checkOldPassword } = require('../Middleware/register.middle')
const {authorize, tokenCheck} = require('../Middleware/auth.middle')
const router = express.Router()

router.post('/register', confirmPassword , checkEmailExist, userRegister)
