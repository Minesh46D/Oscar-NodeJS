...
function App() {
  ...
  return (
    <>
      <div className='h-screen bg-gradient-to-r from-cyan-500 to-blue-500 dark:bg-gradient-to-r dark:from-indigo-500 dark:via-purple-500 dark:to-pink-500  flex justify-center items-center'>
